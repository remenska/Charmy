...
public class JpegEncoder extends Frame
{
    ...
    public JpegEncoder(Image image, int quality, OutputStream out)
    {
                ...
                try {
                	...
                	System.out.println("jpeg.JpegEncoder: "+e.getMessage());
...
// Start of Scan Header
    ...
    void WriteMarker(byte[] data, BufferedOutputStream out) {
        try {
                ...
                System.out.println("3 - IO Error: " + e.getMessage());
        }
    }
    ...
    void WriteArray(byte[] data, BufferedOutputStream out) {
        ...
        try {
                ...
                System.out.println("4 - IO Error: " + e.getMessage());
        }
    }
}
        ...
        void bufferIt(BufferedOutputStream outStream, int code,int size)
	{
        ...
        while(PutBits >= 8) {
                ...
                try
                {
                        ...
                        System.out.println("5 - IO Error: " + e.getMessage());
                }
                if (c == 0xFF) {
                        try
                        {
                                ...
                                System.out.println("6 - IO Error: " + e.getMessage());
                        }
                }
                PutBuffer <<= 8;
                PutBits -= 8;
        ...
        void flushBuffer(BufferedOutputStream outStream) {
                ...
                while (PutBits >= 8) {
                        ...
                        try
                        {
                                ...
                                System.out.println("7 - IO Error: " + e.getMessage());
                        }
                        if (c == 0xFF) {
                                try {
                                        outStream.write(0);
                                        ...
                                        System.out.println("8 - IO Error: " + e.getMessage());
                                }
                        }
                        PutBuffer <<= 8;
                        PutBits -= 8;
                ...
                if (PutBits > 0) {
                        ...
                        try
                        {
                                ...
                                System.out.println("9 - IO Error: " + e.getMessage());
                        }
                }
        }
...
// the only choice.
    	...
    	catch (InterruptedException e) {System.out.println("Errore 11!!");};
