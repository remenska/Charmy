...
/** Superclasse per la gestione delle "actions" attivabili dal menu
	"Edit": "Copy", "Cut", "Delete", "Paste", "Redo" e "Undo". */

public abstract class GraphItemAction implements ActionListener 
{
    ...
    public GraphItemAction(EditGraphInterface rifGraphWindow)
    {
