...
import plugin.topologychannels.utility.listaProcesso.toolbar.ListaProcessoToolBar;
...
public class JListaProcessoPanel 
	...
	//	this.setBorder(new LineBorder(new Color(0,0,0), 2));
		...
		plugData = (plugin.topologychannels.data.PlugData)pd.getPlugDataManager().getPlugData("charmy.plugin.topologychannels");
