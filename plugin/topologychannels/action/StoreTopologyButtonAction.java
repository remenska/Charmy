 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class StoreTopologyButtonAction extends ButtonMouseAdapter {

	/**
	 * 
	 */
	public StoreTopologyButtonAction() {
		super();
				...
				if (SwingUtilities.isLeftMouseButton(evt))
					  {
						  if (numClick == 1)
						  {				  	
							topologyEditor.setEditorStatus(TopologyEditor.DISEGNA_PROCESSO,ElementoProcesso.STORE,false,false);
						  }
						  else
						  {
							...
							topologyEditor.setEditorStatus(TopologyEditor.DISEGNA_PROCESSO,ElementoProcesso.STORE,false,true);
						  }        
					  }
					  else
					  {
