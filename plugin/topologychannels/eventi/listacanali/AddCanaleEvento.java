...
package plugin.topologychannels.eventi.listacanali;
 ...
 * Charmy plug-in
 **/
public class AddCanaleEvento extends SessioneEvento{
	/**
	 * riferimento all'elemento del canale che si aggiunge
	 */
	ElementoCanale elementoCanale = null;
	 ...
	 * @param idDiSessione 
	 */
	public AddCanaleEvento(ElementoCanale ec, ListaCanale lc, long idSessione){
		super(lc, idSessione);
		elementoCanale = ec;
