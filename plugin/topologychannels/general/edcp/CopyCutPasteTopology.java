...
package plugin.topologychannels.general.edcp;
...
import plugin.topologychannels.resource.general.edcp.LinkedListWithID;
...
public class CopyCutPasteTopology extends CopyCutPaste {
	...
	public CopyCutPasteTopology(PlugData pl) {
		...
		pd=(PlugData)plugData.getPlugData("charmy.plugin.topologychannels");
