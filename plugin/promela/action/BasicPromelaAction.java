...
public abstract class BasicPromelaAction implements ActionListener
{
    
    protected AlgoManagerProm gestioneAlgo;
    
    
    public BasicPromelaAction(AlgoManagerProm istAM)
    {
    	gestioneAlgo = istAM;
    }
