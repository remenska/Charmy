...
/**
	Gestione dell'operazione di "cut" alla pressione del
	relativo pulsante appartenente alla "EditToolBar".
*/

public class CutGraphButtonAction extends GraphButtonAction
{
       
    public CutGraphButtonAction(EditGraphInterface rifGraphWindow)
    {
