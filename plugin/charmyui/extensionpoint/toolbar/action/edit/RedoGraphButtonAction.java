...
/**
	Gestione dell'operazione di "redo" alla pressione del
	relativo pulsante appartenente alla "EditToolBar".
*/

public class RedoGraphButtonAction extends GraphButtonAction 
{
    
    public RedoGraphButtonAction(EditGraphInterface rifGraphWindow)
    {
