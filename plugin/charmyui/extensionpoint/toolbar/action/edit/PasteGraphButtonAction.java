...
/**
	Gestione dell'operazione di "paste" alla pressione del
	relativo pulsante appartenente alla "EditToolBar".
*/

public class PasteGraphButtonAction extends GraphButtonAction
{
    
    public PasteGraphButtonAction(EditGraphInterface rifGraphWindow)
    {
