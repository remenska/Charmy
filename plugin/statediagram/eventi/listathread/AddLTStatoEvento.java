 ...
 * Charmy plug-in
 **/
public class AddLTStatoEvento extends SessioneEvento{
	...
	/**
	 * 
	 * @param ElementoStato clone dell'elemento stato aggiunto
	...
	public AddLTStatoEvento(ElementoStato ep, ListaStato lp, ThreadElement te,   ListaThread lt, long idSessione){
		super(lt, idSessione);
		threadElement = te;
		elementoStato = ep;
		listaStato = lp;
