 ...
 * Charmy plug-in
 **/
public class AddThreadEvento extends SessioneEvento{
	/**
	...
	/**
	 * Costruttore 
	 * @param ThreadElement aggiunto
	 * @param listaThread dove si aggiunge il ThreadElement
	 * @param idSessione identificativo della sessione
	 */
	public AddThreadEvento(ThreadElement te,   ListaThread lt, long idSessione){
		super(lt, idSessione);
		threadElement = te;
	}
