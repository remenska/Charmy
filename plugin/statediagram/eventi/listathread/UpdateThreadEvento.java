 ...
 * Charmy plug-in
 **/
public class UpdateThreadEvento extends SessioneEvento{
	/**
	 ...
	 */
	public UpdateThreadEvento(ThreadElement oldte, ThreadElement newte,   ListaThread lt, long idSessione){
		super(lt, idSessione);
