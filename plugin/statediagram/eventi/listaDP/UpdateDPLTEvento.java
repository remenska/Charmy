 ...
 * Charmy plug-in
 **/
public class UpdateDPLTEvento extends SessioneEvento{
	/**
	 ...
	 * @param idSessione è lìidentificativo della sessione corrente
	 * 
	 */
	public UpdateDPLTEvento(ListaThread lt, ListaDP ldp, long idSessione){
