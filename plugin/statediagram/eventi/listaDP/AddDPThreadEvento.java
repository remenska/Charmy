...
/**
 * messaggio generato per l'aggiunta di un ThreadElement nella lista dei thread
 * @author michele
 * Charmy plug-in
 **/
public class AddDPThreadEvento extends SessioneEvento{
	/**
	 ...
	 */
	public AddDPThreadEvento(ThreadElement te,   ListaThread lt, ListaDP ldp, long idSessione){
