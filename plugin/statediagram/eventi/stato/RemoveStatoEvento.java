...
/**
 * evento generato in seguito all'aggiunta (prima/dopo) di un ElementoStato nella lista
 * 
 * @author michele
 * Charmy plug-in
 **/
public class RemoveStatoEvento extends SessioneEvento {
