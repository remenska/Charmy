 ...
 * Charmy plug-in
 **/
public class UpdateThreadStatoEvento extends SessioneEvento {
	 ...
	 */
	public UpdateThreadStatoEvento(
		ElementoStato oldep,
		ElementoStato newep,
		ListaStato lp,
		ThreadElement te, long idSessione) {
	...
	/**
	 * ritorna la listastato dove è contenuto l'elemento
	 * @return
	 */
