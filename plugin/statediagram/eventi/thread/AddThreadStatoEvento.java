 ...
 * Charmy plug-in
 **/
public class AddThreadStatoEvento extends SessioneEvento{
	 ...
	 */
	public AddThreadStatoEvento(ElementoStato ep, ListaStato lp, ThreadElement te, long idSessione){
		super(te, idSessione);
		listaStato = lp;
		elementoStato = ep;
	}
	...
	/**
	 * restituisce l'elemento stato inserito
	 * @return
	 */
	 ...
	 * restituisce la sorgente del messaggio
	 */	
	public ThreadElement getSorgente(){
			return (ThreadElement)getSource();
		}
