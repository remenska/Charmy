...
/** La classe specializza la classe 'GraficoTipo' realizzando un'ellisse
    ...
    dell'oggetto sono quelle di uno stato di tipo 'BUILD'. */

public class GraficoTipoBuild extends GraficoTipo implements Serializable
{
     ...
     */
    public GraficoTipoBuild(int x0, int y0, ElementoBase update)
    {
