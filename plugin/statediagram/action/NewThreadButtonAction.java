...
/** Gestione dell'operazione di "Creazione Nuovo Thread" 
	alla pressione del relativo pulsante. */

public class NewThreadButtonAction extends GraphButtonAction 
{
    
    public NewThreadButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((StateWindow)Finestra).opNewThread();
