...
/** Gestione dell'operazione di "Rinomina Thread" ("Thread's Properties") 
	alla pressione del relativo pulsante. */

public class RenameThreadButtonAction extends GraphButtonAction 
{
    
    public RenameThreadButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((StateWindow)Finestra).opRenameThread();       
    }
