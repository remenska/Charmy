...
/** Gestione dell'operazione di "Duplicazione Thread" 
	alla pressione del relativo pulsante. */

public class CopyThreadButtonAction extends GraphButtonAction 
{
    
    public CopyThreadButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((StateWindow)Finestra).opCopyThread();       
    }
