...
import plugin.statediagram.eventi.messaggio.UpdateMessaggioEvento;
	...
	/**
	 * IListaMessaggioListener è l'interface listener per ricevere la notifica quando una 
	 * ListaMessaggio è  modificata, attraverso l'inserimento o la cancellazione di un
	 * ElementoMessaggio l'implementazione di questa interfaccia deve essere registrata
	 * nel metodo ListaMessaggio.addListener(listener ) per ricevere la notifica.  
	 *
	 *<p>
	 *
	 ...
	 * @version Charmy 2.1
	 */
	public interface IListaMessaggioListener  extends EventListener, Serializable{
