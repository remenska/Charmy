...
package plugin.topologydiagram.dialog;
...
public class FinestraGraphEditor extends JDialog
{
    ...
    */
    public FinestraGraphEditor(WithGraphEditor ce, Frame lframe, String titolo)
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            try
            {
				...
				else
				{
                    ...
                    cEditor.getFileManager().setChangeWorkset(TopologyWindow.idPluginFileCharmy,true);
