...
import plugin.topologydiagram.data.delegate.DelegateListaProcessoListener;
import plugin.topologydiagram.graph.GraficoTipoDummy;
import plugin.topologydiagram.graph.GraficoTipoProcesso;
import plugin.topologydiagram.graph.GraficoTipoStore;
	...
	implements Serializable //, SendListener
{
	...
	/**
	 *  (non-Javadoc)
	 * @see plugin.topologydiagram.resource.data.ListaProcessoStato#restoreFromFile()
	 */
