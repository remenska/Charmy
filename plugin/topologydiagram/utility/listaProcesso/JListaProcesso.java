...
import plugin.topologydiagram.dialog.FinestraElementoBoxTesto;
...
public class JListaProcesso 
	...
	public JListaProcesso(IPlugData pd) {
		super(((plugin.topologydiagram.data.PlugData)
				(pd.getPlugDataManager().getPlugData("charmy.plugin.topology"))).getListaProcesso().toArray());
		plugData = ((plugin.topologydiagram.data.PlugData)
		(pd.getPlugDataManager().getPlugData("charmy.plugin.topology")));
		modality = NODUMMY;
