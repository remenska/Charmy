 ...
 * @author michele
 * Charmy plug-in
 * evento generato dalla listaDS per la rimozione di un ElementoClasse
 **/
public class RemoveListaDSClasseEvento extends SessioneEvento{
	/**
	 * riferimento all'elemento del canale che si rimuove
	 */
	 ...
	 * @param idDiSessione 
	 */
	public RemoveListaDSClasseEvento(ElementoClasse ec, ListaClasse lc, SequenceElement se,ListaDS lds, long idSessione){
