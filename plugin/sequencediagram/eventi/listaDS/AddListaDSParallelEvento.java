 ...
 * @author flamel
 * Charmy plug-in
 * Aggiunta Paralell operator,
 * Evento generato da listaDS
 * 
 **/
public class AddListaDSParallelEvento 
	 ...
	 * @param idDiSessione 
	 */
	public AddListaDSParallelEvento(ElementoParallelo ec, ListaParallel lc, SequenceElement se,ListaDS lds, long idSessione){
