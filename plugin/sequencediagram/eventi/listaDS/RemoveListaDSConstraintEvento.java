 ...
 * 
 **/
public class RemoveListaDSConstraintEvento extends SessioneEvento{
	/**
	 ...
	 * @param idDiSessione 
	 */
	public RemoveListaDSConstraintEvento(ElementoConstraint ec, ListaConstraint lc, SequenceElement se,ListaDS lds, long idSessione){
