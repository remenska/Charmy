 ...
 * 
 **/
public class RemoveListaDSSimEvento extends SessioneEvento{
	/**
	 ...
	 * @param idDiSessione 
	 */
	public RemoveListaDSSimEvento(ElementoSim ec, ListaSim lc, SequenceElement se,ListaDS lds, long idSessione){
