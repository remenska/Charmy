 ...
 **/
public class RemoveListaDSLinkEvento extends SessioneEvento{
	/**
	 ...
	 * @param listaDs generante l'evento
	 * @param idDiSessione 
	 */
	public RemoveListaDSLinkEvento(ElementoSeqLink ec, ListaSeqLink lc, SequenceElement se,ListaDS lds, long idSessione){
