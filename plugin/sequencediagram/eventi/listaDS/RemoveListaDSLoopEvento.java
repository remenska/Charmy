 ...
 * @author flamel
 * Charmy plug-in
 * Rimozione di una linea di tempo, il numero masLoopo di linee ? 11, il minimo 3
 * Evento generato da listaDS
 * 
 **/
public class RemoveListaDSLoopEvento extends SessioneEvento{
	/**
	 ...
	 * @param idDiSessione 
	 */
	public RemoveListaDSLoopEvento(ElementoLoop ec, ListaLoop lc, SequenceElement se,ListaDS lds, long idSessione){
