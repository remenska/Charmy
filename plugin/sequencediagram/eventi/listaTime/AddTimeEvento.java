 ...
 **/
public class AddTimeEvento extends SessioneEvento{
	/**
	 * riferimento all'elemento del canale che si aggiunge
	 */
	ElementoTime elementoTime = null;



	/**
	 * Costruttore
	 * @param ep ElementoTime aggiunto
	 * @param lp lista al quale si aggiunge L'elemento
	 * @param idDiSessione 
	 */
	public AddTimeEvento(ElementoTime ec, ListaTime lc, long idSessione){
		super(lc, idSessione);
		elementoTime = ec;
