 ...
 **/
public class AddClasseEvento extends SessioneEvento{
	/**
	 * riferimento all'elemento del canale che si aggiunge
	 */
	ElementoClasse elementoClasse = null;
	 ...
	 * @param idDiSessione 
	 */
	public AddClasseEvento(ElementoClasse ec, ListaClasse lc, long idSessione){
		super(lc, idSessione);
		elementoClasse = ec;
