 ...
 * @author flamel 2005
 * Charmy plug-in
 * Aggiunta operatore loop
 **/
public class AddSequenceLoopEvento 
	extends SessioneEvento{
	/**
	 * riferimento all'elemento si aggiunge
	 */
	 ...
	 * @param idDiSessione 
	 */
	public AddSequenceLoopEvento(ElementoLoop ec, ListaLoop lc, SequenceElement se, long idSessione){
		super(se, idSessione);
		elementoLoop = ec;
		listaLoop = lc;
	}
