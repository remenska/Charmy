 ...
 **/
public class UpdateSequenceLinkEvento extends SessioneEvento {
	/**
	 ...
	 * @param idSessione
	 */
	public UpdateSequenceLinkEvento(ElementoSeqLink oldec, ElementoSeqLink newec, ListaSeqLink lc, SequenceElement se, long idSessione) {
		super(se, idSessione);
