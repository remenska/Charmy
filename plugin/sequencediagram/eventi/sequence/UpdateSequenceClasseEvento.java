 ...
 **/
public class UpdateSequenceClasseEvento 
	 ...
	 */
	public UpdateSequenceClasseEvento(ElementoClasse oldec, ElementoClasse newec, ListaClasse lc, SequenceElement se, long idSessione) {
		super(se, idSessione);
