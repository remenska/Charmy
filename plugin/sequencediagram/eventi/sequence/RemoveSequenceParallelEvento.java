 ...
 **/
public class RemoveSequenceParallelEvento 
	...
	/**
	 * Costruttore
	 * @param ec ElementoParallel Rimosso
	 * @param lc lista dalla quale si aggiunge L'elemento
	 * @param SequenceElement contenente il tutto
	 * @param idDiSessione 
	 */
	public RemoveSequenceParallelEvento(ElementoParallelo ec, ListaParallel lc, SequenceElement se, long idSessione){
		super(se, idSessione);
		elementoParallel = ec;
		listaParallel = lc;
	}
