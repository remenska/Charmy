 ...
 **/
public class AddSequenceConstraintEvento 
	 ...
	 * @param idDiSessione 
	 */
	public AddSequenceConstraintEvento(ElementoConstraint ec, ListaConstraint lc, SequenceElement se, long idSessione){
		super(se, idSessione);
