 ...
 **/
public class RemoveSequenceLinkEvento extends SessioneEvento{
	/**
	 ...
	 * @param idDiSessione 
	 */
	public RemoveSequenceLinkEvento(ElementoSeqLink ec, ListaSeqLink lc, SequenceElement se, long idSessione){
		super(se, idSessione);
		elementoSeqLink = ec;
		listaSeqLink = lc;
	}
