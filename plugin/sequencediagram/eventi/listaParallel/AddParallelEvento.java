 ...
 **/
public class AddParallelEvento extends SessioneEvento{
	/**
	 * riferimento all'elemento  che si aggiunge
	 */
	ElementoParallelo elementoParallel = null;



	/**
	 * Costruttore
	 * @param ep ElementoParallel aggiunto
	 * @param lp lista al quale si aggiunge L'elemento
	 * @param idDiSessione 
	 */
	public AddParallelEvento(ElementoParallelo ec, ListaParallel lc, long idSessione){
		super(lc, idSessione);
		elementoParallel = ec;
