 ...
 * @author michele
 * Charmy plug-in
 * Rimozione di una linea di tempo, il numero massimo di linee è 11, il minimo 3
 **/
public class RemoveConstraintEvento extends SessioneEvento{
	/**
	 ...
	 */
	public RemoveConstraintEvento(ElementoConstraint ec, ListaConstraint lc, long idSessione){
		super(lc, idSessione);
