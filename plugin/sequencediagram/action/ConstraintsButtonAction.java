...
public class ConstraintsButtonAction extends MouseAdapter implements MouseListener 
{
    ...
    public ConstraintsButtonAction(SequenceWindow clwnd, SequenceToolBar tbar, AbstractButton pls)
    {
        Finestra = clwnd;
        rifToolBar = tbar;
        pulsante = pls;
    ...
    public void mouseReleased(MouseEvent evt) 
    {
        ...
        {           
            if (numClick == 1)
            {
                ...
                Finestra.setWindowStatus(SequenceEditor.CONSTRAINT,0,0,false);            
            }
            else
            {
            	// Doppio click => Blocco del pulsante.
                pulsante.setBorder(BorderFactory.createBevelBorder(1,Color.LIGHT_GRAY,Color.GRAY));
                Finestra.setWindowStatus(SequenceEditor.CONSTRAINT,0,0,true);            
            }
        }
        else
        {
