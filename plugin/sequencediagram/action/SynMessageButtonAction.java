...
/** Gestione dell'azione di inserimento di uno o più messaggi di tipo 
	Synchronous nel Sequence Diagram alla pressione del relativo pulsante_
	Implementazione dell'interfaccia "MouseListener", anziché
	"ActionListener" per gestione blocco/sblocco pulsante. */

public class SynMessageButtonAction extends MouseAdapter implements MouseListener 
{
    ...
    public SynMessageButtonAction(SequenceWindow clwnd, SequenceToolBar tbar, AbstractButton pls)
    {
        Finestra = clwnd;
        rifToolBar = tbar;
        pulsante = pls;
