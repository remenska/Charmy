...
/** Gestione dell'operazione di inserimento di una "Time's Line"
	alla pressione del relativo pulsante. */

public class TimeLineButtonAction extends GraphButtonAction 
{
    
    public TimeLineButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((SequenceWindow)Finestra).addTimeLine();       
    }
