...
/** Attivazione della creazione di un Sequence 
	alla pressione del relativo pulsante. */

public class NewSequenceButtonAction extends GraphButtonAction 
{
    
    public NewSequenceButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((SequenceWindow)Finestra).opNewSequence();       
    }
