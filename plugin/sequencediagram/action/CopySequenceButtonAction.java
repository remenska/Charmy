...
/** Attivazione dell'operazione di "Duplicazione Sequence" 
	alla pressione del relativo pulsante. */

public class CopySequenceButtonAction extends GraphButtonAction 
{
    
    public CopySequenceButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((SequenceWindow)Finestra).opCopySequence();       
    }
