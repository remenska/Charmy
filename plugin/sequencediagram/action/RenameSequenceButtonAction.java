...
/** Gestione dell'operazione di "Sequence's Properties" 
	alla pressione del relativo pulsante. */

public class RenameSequenceButtonAction extends GraphButtonAction 
{
    
    public RenameSequenceButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((SequenceWindow)Finestra).opRenameSequence();       
    }
