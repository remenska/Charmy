...
/** Attivazione dell'eliminazione del Sequence selezionato 
	alla pressione del relativo pulsante. */

public class DelSequenceButtonAction extends GraphButtonAction 
{
    
    public DelSequenceButtonAction(WithGraphWindow rifGraphWindow)
    {
    ...
    {
        ((SequenceWindow)Finestra).delSequence();       
    }
