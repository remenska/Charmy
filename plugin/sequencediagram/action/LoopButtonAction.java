...
/** Gestione dell'azione di inserimento dell'operatore Loop*/

public class LoopButtonAction extends MouseAdapter implements MouseListener 
{
    ...
    public LoopButtonAction(SequenceWindow clwnd, SequenceToolBar tbar, AbstractButton pls)
    {
        Finestra = clwnd;
        rifToolBar = tbar;
        pulsante = pls;
