 ...
 * Charmy plug-in
 **/
 public interface IListaSimNotify {
    
    /** 
	 * Notifica l'inserimento di un nuovo Elemento 
	 */
	public  void notifyAdd(ElementoSim eps); 
    
    
	/** 
	 * Notifica la cancellazione di un nuovo Elemento 
	 */
	public  void notifyRemove(ElementoSim eps); 
    
  
	/** 
	 * Notifica la Modifica di un nuovo Elemento 
	 */
	public  void notifyUpdate(ElementoSim oldeps, ElementoSim neweps); 
