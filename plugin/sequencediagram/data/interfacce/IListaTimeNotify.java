 ...
 * Charmy plug-in
 **/
public interface IListaTimeNotify {

	/** 
	 * Notifica l'inserimento di un nuovo Elemento 
	 */
	public  void notifyAdd(ElementoTime eps); 
    
    
	/** 
	 * Notifica la cancellazione di un nuovo Elemento 
	 */
	public  void notifyRemove(ElementoTime eps); 
    
  
	/** 
	 * Notifica la Modifica di un nuovo Elemento 
	 */
	public  void notifyUpdate(ElementoTime oldeps, ElementoTime neweps); 
