 ...
 * Charmy plug-in
 **/
public interface IListaParallelNotify {
    
    /** 
	 * Notifica l'inserimento di un nuovo Elemento 
	 */
	public  void notifyAdd(ElementoParallelo eps); 
    
    
	/** 
	 * Notifica la cancellazione di un nuovo Elemento 
	 */
	public  void notifyRemove(ElementoParallelo eps); 
    
  
	/** 
	 * Notifica la Modifica di un nuovo Elemento 
	 */
	public  void notifyUpdate(ElementoParallelo oldeps, ElementoParallelo neweps); 
