 ...
 * @version Charmy 2.1
 */
public interface IListaClasseListener extends EventListener, Serializable {

	/**
	 * Chiamata quando un ElementoClasse è stato inserito nella lista
	 * @param event l'evento che descrive il tipo di inserimento
	 */
	public void classeAdded(AddClasseEvento event);

	/**
	 * Chiamata quando un ElementoClasse è stato rimosso dalla lista
	 * @param event l'evento che descrive il tipo di rimozione
	 */
	public void classeRemoved(RemoveClasseEvento event);

	/**
	 * Chiamata quando un ElementoClasse è stato modificato dalla lista
	 * @param event l'evento che descrive il tipo di rimozione
	 */
